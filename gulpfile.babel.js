...
const source = {
    path: 'source/resources/__path/**/*.*',
    html: 'source/resources/html/**/*.html',
    css: 'source/resources/scss/',
    js: 'source/resources/js/',
    img: 'source/resources/img/',
    ir: 'source/resources/ir/',
    guide: 'source/resources/html/__guide/resources/',
    commonResource: 'source/resources/common/',
}

const dist = {
    path: 'dist/resources/__path/',
    html: 'dist/',
    css: 'dist/resources/css/',
    js: 'dist/resources/js/',
    img: 'dist/resources/img/',
    guide: 'dist/resources/html/__guide/resources/',
...
const imgTask = () => {
    return (
        src(source.img + '**/*.{png,gif,jpg,svg,ico}', {
            encoding: false
        })
        .pipe(dest(dist.img))
        .pipe(browserSync.reload({
